  ...
  return (
    <div id="accordion-collapse" data-accordion="collapse">
        <h2 id="accordion-collapse-heading-1">
            ...
            <span>{question}</span>
            { !show && <svg dataAccordion-icon className="w-3 h-3 rotate-180 shrink-0" ariaHidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" stroke-width="2" d="M9 5 5 1 1 5"/>
            </svg> }
            { show && <svg dataAccordion-icon className="w-3 h-3 shrink-0" ariaHidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" stroke-width="2" d="M9 5 5 1 1 5"/>
            </svg> }
